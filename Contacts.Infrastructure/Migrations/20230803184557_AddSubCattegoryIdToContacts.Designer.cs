...
namespace Contacts.Infrastructure.Migrations
{
    ...
    [Migration("20230803184557_AddSubCattegoryIdToContacts")]
    partial class AddSubCattegoryIdToContacts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Contacts.Infrastructure.Repositories.Postgres.Models.ContactsDb", b =>
                {
                    ...
                    b.HasIndex("SubCategoryId")
                        .HasDatabaseName("ix_contacts_sub_category_id");
            ...
            modelBuilder.Entity("Contacts.Infrastructure.Repositories.Postgres.Models.ContactsDb", b =>
                {
                    ...
                    b.HasOne("Contacts.Infrastructure.Repositories.Postgres.Models.SubcategoriesDb", "SubCategory")
                        .WithMany()
                        .HasForeignKey("SubCategoryId")
                        .HasConstraintName("fk_contacts_subcategories_sub_category_id");
